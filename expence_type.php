...
<div class="box">
<div class="box-head"><h3>Expences Type</h3></div>
<?php
if(isset($_POST['create']))
{
	$sql = "INSERT INTO `expences_type` (`name`, `description`) VALUES ('".$_POST['name']."', '".$_POST['desc']."');";
	$mysql->execute($sql);
	?>
...
{
	$sql = "UPDATE `expences_type` set `is`=0 where `id`='".$_POST['id']."'";
	$mysql->execute($sql);
	?>
    <div class="alert alert-block alert-success">
							  <a class="close" data-dismiss="alert" href="#">×</a>
...
<tbody>
<?php
$sql = "select * from expences_type where `is`=1";
