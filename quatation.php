...
<?php include"classes/quatation.php"; ?>
<?php include"itemSearch.php";?>
<?php include"quatation_mode.php"; ?>
    ...
    <div class="row-fluid">
        ...
        <div class="box">
          ...
          <table class="table table-striped table-detail">
            <tr>
              ...
              <th>Date: </th>
              <td style="white-space:nowrap"><strong><?php echo date('d-m-Y') ?></strong></td>
            </tr>
            <tr>
              <?php 
			  $billing->setUnclosed();
              ...
              <select name="unClosedBills" class="cho" style="width:100px;">
                  <?php 
				$lockCount=0;
      ...
      <div class="span4">
        <div class="box">
		  ...
		  {
			  window.open("product_entry_tmp.php","Product Load",1,'width=50,height=50');
		  }
		  function edit_product()
		  {
			  id = $("#product_update").val();
			  window.open("product_edit_tmp.php?id="+id,"Product Load",1,'width=50,height=50');
		  }
		  function product_push(id,pid,photo,name,amnt,type,available,date,vat)
		  {
			  products.push({ id:id,pid:pid,photo:photo,name:name,amnt:amnt,type:type,available:available,date:date,vat:vat});
			  product_load(id)
		  }
		  function product_update(id,pid,photo,name,amnt,type,available,date,vat)
		  {
...
<?php
          ...
          <tr>
            ...
            <th class="discountedTotal" style="text-align:right;color:#000;font-weight:bold"></th>
          </tr>
          <tr>
