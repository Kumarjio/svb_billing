      ...
      <div class="span12">
        ...
        <table border="1" width="100%" align="center" cellspacing="5" cellpadding="5" class="bgcolor" id="items">
          <tr id="itemsEntry">
			...
			<th width="6%" onClick="$('#MitemGst').focus()"> <input id="Mnetgst" type="hidden" class="MnetAmnt">
              <input id="MitemGst" type="text" class="billTextRight tRight MitemGst" placeholder="GST" readonly autocomplete="off" >
            </th>
            <th width="6%"> <input id="MitemDis" type="text" class="billTextRight tRight MitemDis" placeholder="Discount"  autocomplete="off" >
            </th>
...
<?php
          ...
          <?php						
            ...
            <th class="borserlbr bgcolor"><input name="total" id="total" type="text" class="billTextRight tRight"  readonly>
			<input id="other_discount" type="text" class="billTextRight tRight amnt hide " readonly></th>
			<th class="borserlbr bgcolor"><input id="gst_total" type="text" class="billTextRight tRight gst_total" readonly></th>
            <th class="borserlbr bgcolor"><input id="netdiscount" type="text" class="billTextRight tRight"  readonly></th>
          </tr>
          <!--<tr>
            <th align="right" class="borserlbr bgcolor">Total</th>
