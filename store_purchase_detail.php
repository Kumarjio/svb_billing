...
?>
    <form action="" method="post">
      <div class="box">
        <div class="box-head"><h3>Store Purchase Details</h3></div>
        <br>
        ...
        <div class="cl">
          ...
          <div class="details pull-left userprofile">
            <table class="table table-striped table-detail">
              ...
              <tr>
                <th>Name: </th>
                <th><a href="dealer_profile.php?id=<?php echo $cust['id'] ?>"><?php echo $cust['name'] ?></a></th>
              </tr>
              <tr>
                <th>Phone:</th>
