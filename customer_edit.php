...
if(isset($_POST['editCustomer']))
{
	...
	$photo="";
	$ip=$_SESSION['ip'];
	$query = "UPDATE  `customers` SET `name`='$customer_name', `email`='$customer_email', `dob`='$date_of_birth',`gender`='".$_POST['gender']."',`wedding_day`='$wedding_day', `phone`='$customer_phone', `address`='$customer_address', `it`=NOW(),`discount`='".floatval($discount)."',`tin_no`='".$_POST['customer_tin']."',`gst_no`='".$_POST['customer_gst']."' WHERE  `id`=$id;";
	$mysql->execute($query);
	$r=$mysql->execute($sql);
          ...
          <div class="box-content">
            <form action="customer_edit.php" class="form-horizontal" method="post" enctype="multipart/form-data">
			  ...
			  <div class="control-group">
                ...
                <div class="controlsx">
                  <input type="text" name="customer_gst" id="customer_gst" class='text' value="<?php echo $customer['gst_no'] ?>">
                </div>
              </div>
              <div class="control-group">
