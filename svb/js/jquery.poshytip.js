...
(function($) {
	...
	$.Poshytip.prototype = {
		init: function() {
			...
			var title = this.$elm.children('.tooltip').html();
	...
	$.fn.poshytip.defaults = {
		...
		showAniDuration: 	50,		// show animation duration - set to 0 if you don't want show animation
		hideAniDuration: 	10		// hide animation duration - set to 0 if you don't want hide animation
	};
