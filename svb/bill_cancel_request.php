...
?>
    <div class="box">
      <div class="box-head">
        <h3>Bill Cancellation Request</h3>
      </div>
      <div class="box-content">
<?php
if(isset($_POST['send']))
{
	$sql = "INSERT INTO `bill_cancel_request` 
...
?>
        <form action="bill_cancel_request.php" class="form-horizontal" method="post" enctype="multipart/form-data">
          <div class="control-group">
            <label for="selsear2" class="control-label">Bill No</label>
            <div class="controls">
