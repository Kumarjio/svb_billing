...
if($curFile=='production_stock_wb.php' || $curFile=='billing.php' || $curFile=='purchase.php' || $curFile=='wastage.php' || $curFile=='store_purchase.php' || $curFile=='store_stock_request.php'  || $curFile=='bill_printing.php' || $curFile == 'billing_wb.php'  || $curFile=='bill_printing_wb.php')
{
	$dataOnly =1;
}
