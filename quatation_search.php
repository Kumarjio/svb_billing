...
?>
      ...
      <table class="table table-bordered table-striped" align="center">
        ...
        <tbody>
          <?php
		$sql = "select * from quatation as bl where bl.date between '".$from."' and '".$to."'";
		...
		?>
          <tr>
            ...
            <td><?php if($r['lock']) echo 'Locked'; else echo 'Not Locked' ?>
              <br>
              <?php if($r['confirmed_bill_no']!='') echo 'Confirmed Bill No: '.$r['confirmed_bill_no']; else echo 'Not Yet Confirmed' ?></td>
          </tr>
          <?php
		}
		?>
