...
?>
<div class="box">
<div class="box-head"><h3>Expence</h3></div>
<?php 
if(isset($_POST['update']))
{
	 $sql ="UPDATE `expences` set `date`='".$_POST['date']."', `e_id`=".$_POST['exp'].", `person`='".$_POST['per']."', `amount`=".$_POST['amnt'].", 
...
{
	 $sql ="UPDATE `expences` set `is`=0 WHERE `id`=".$_POST['id'].";";
	$mysql->execute($sql);
	?>
    <div class="alert alert-block alert-success">
							  <a class="close" data-dismiss="alert" href="#">×</a>
...
<thead><th>Sno</th><th>Date</th><th>Expence</th><th>Given To</th><th>Reason</th><th>Amount</th><th></th></thead>
<tbody>
<?php
$sql = "select 
...
while($r = mysqli_fetch_array($rst[0]))
{
    ...
    <td><form action="expence_edit.php" method="post"><input type="hidden" name="id" value="<?php echo $r['id'] ?>">
