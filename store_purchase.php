...
<?php include"itemSearch3.php";?>
<?php include"store_purchase_mode.php"; ?>
        ...
        <div class="box">
          <div class="box-head">
            <h3>Dealer Details&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  ...
			  {?>
              <a onClick="addCustomer()">Add New</a>&nbsp;&nbsp;&nbsp;<a onClick="loadCustomer()">Load Dealer</a>
              </th>
              <?php }
			  else{?>
              <a onClick="addCustomer()">Add New</a>&nbsp;&nbsp;&nbsp;<a onClick="loadCustomer()">Replace Dealer</a>
              </th>
              <?php  }?>
            </h3>
          </div>
          ...
          <table class="table table-striped table-detail">
            <tr>
              ...
              <!--<th>Address: </th>
              <td style="vertical-align:top" id="customerAddress"><?php //echo $customer[3] ?></td>-->
            </tr>
          </table>
        </div>
      </div>
        ...
        <div class="itemsList">
          <table border="1" width="100%" cellspacing="5" cellpadding="3">
            ...
            <tr class="searchResult" style="border-bottom:#CCC 1px dashed;" onClick="addFromTray('<?php echo $products[$key]['pid'] ?>')" >
              <td align="center"><?php echo $products[$key]['pid'] ?></td>
