...
{ 
	...
	$query="update product set
				`pid`='".$id."',`hsm_code`='".$_POST['hsm_code']."',`gid`='".$_POST['p_group']."',`cid`='".$_POST['p_cat']."',
				...
				`mrp`='".$mrp."', `vat`='".$p_vat."', `gst`='".addslashes(json_encode($_POST['gst']))."', `desc`='".addslashes($p_desc)."',
    ...
    <div class="box-content">
      <form action="productEdit.php" class="form-horizontal" method="post" enctype="multipart/form-data">
		...
		<div class="control-group">
          ...
          <div class="controlsx">
            <input type="text" name="hsm_code" id="hsm_code" class='text' value="<?php echo $row['hsm_code']; ?>"  >
          </div>
        </div>
        <div class="control-group">
		...
		<div class="control-group">
		  ...
		  <div class="controlsx">
			<input type="text" name="gst[cgst]" id="cgst" value="<?php echo $gst['cgst'] ?>" class="text">
		  </div>
		</div>
		...
		<div class="control-group">
		  ...
		  <div class="controlsx">
			<input type="text" name="gst[sgst]" id="sgst"  value="<?php echo $gst['sgst'] ?>" class="text">
		  </div>
		</div>
