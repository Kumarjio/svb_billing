...
while($r = mysqli_fetch_array($rst[0]))
{
	...
	?>	
    products.push({ id:"<?php echo $r['id'] ?>",pid:"<?php echo $r['pid'] ?>",photo:"<?php echo $r['photo'] ?>",name:"<?php echo addslashes($name) ?>",amnt:"<?php echo $price ?>",type:"<?php echo $r['type'] ?>",available:"<?php echo $r['available'] ?>",date:"<?php echo $r['p_date'] ?>",vat:"<?php echo $pvat ?>" });  
  <?php
}
?>
</script>
