...
if(isset($_POST['pay']))
{
	if($_POST['recieved']!=0)
	{
		...
		<div class="alert alert-block alert-success"> <a class="close" data-dismiss="alert" href="#">×</a>
				  ...
				  Rs: <?php echo $mysql->currency($_POST['recieved']-$_POST['returned']) ?> Paid Successfully for Bill 
				  <a href="bill_detail.php?billno=<?php echo strtoupper($_POST['bill'])  ?>"><?php echo strtoupper($_POST['bill'])  ?></a> !
        ...
        <center>
          <table align="center" cellpadding="10" cellspacing="10" class=""  >
            ...
            <form method="post" id="form1">
              ...
              <td>
              <?php
			  $sql = "select b.bill_no,c.name from bill as b,customers as c where c.id=b.customer_id and b.lock=1 and b.trans_close=0 and b.is=1";
			  $rst = $mysql->execute($sql);
			  ?>
